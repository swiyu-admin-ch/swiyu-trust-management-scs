...
export class TaskListComponent implements AfterViewInit {
  ...
  dataSource = new MatTableDataSource<TaskListItem>();
  pageSize = 10;
  pageIndex = 0;
  totalItems = 0;
  ...
  isActionAllowed(action: TaskAction, task: TaskListItem) {
  ...
  detailRoute(task: TaskListItem): string[] {
