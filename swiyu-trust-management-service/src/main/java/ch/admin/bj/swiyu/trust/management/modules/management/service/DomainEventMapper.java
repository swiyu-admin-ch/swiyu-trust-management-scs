...
public class DomainEventMapper {
    ...
    private static DomainEventTypeDto toDomainEventTypeDto(DomainEventType source) {
        return switch (source) {
            case BUSINESS_PARTNER_IDENTITY_ACTIVATED -> null;
            case BUSINESS_PARTNER_IDENTITY_DEACTIVATED -> null;
            case BUSINESS_PARTNER_IDENTITY_UPDATED -> null;
            ...
            case TRUST_ONBOARDING_RESUBMITTED -> DomainEventTypeDto.TRUST_ONBOARDING_RESUBMITTED;
            case TASK_NOTE_ADDED -> DomainEventTypeDto.TASK_NOTE_ADDED;
            case TASK_ASSIGNED -> DomainEventTypeDto.TASK_ASSIGNED;
            ...
            case PROTECTED_VERIFICATION_AUTHORIZATION_ADDED -> DomainEventTypeDto.PROTECTED_VERIFICATION_AUTHORIZATION_ADDED;
            case PROTECTED_VERIFICATION_AUTHORIZATION_REMOVED -> DomainEventTypeDto.PROTECTED_VERIFICATION_AUTHORIZATION_REMOVED;
            case PROTECTED_ISSUANCE_AUTHORIZATION_ADDED -> DomainEventTypeDto.PROTECTED_ISSUANCE_AUTHORIZATION_ADDED;
            case PROTECTED_ISSUANCE_AUTHORIZATION_REMOVED -> DomainEventTypeDto.PROTECTED_ISSUANCE_AUTHORIZATION_REMOVED;
            case PROTECTED_VERIFICATION_REQUEST_RECEIVED -> DomainEventTypeDto.PROTECTED_VERIFICATION_REQUEST_RECEIVED;
            case PROTECTED_VERIFICATION_REQUEST_APPROVED -> DomainEventTypeDto.PROTECTED_VERIFICATION_REQUEST_APPROVED;
            case PROTECTED_VERIFICATION_REQUEST_REJECTED -> DomainEventTypeDto.PROTECTED_VERIFICATION_REQUEST_REJECTED;
        };
    }
}
