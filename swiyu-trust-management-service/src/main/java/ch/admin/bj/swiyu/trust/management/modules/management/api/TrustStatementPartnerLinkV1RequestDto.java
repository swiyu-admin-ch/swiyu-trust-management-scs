...
@EqualsAndHashCode
@NoArgsConstructor
public abstract class TrustStatementPartnerLinkV1RequestDto {
    ...
    @NotNull
    @Schema(description = "the valid from date", example = "2025-01-01T00:00:00Z")
    Instant validFrom;

    @NotNull
    @Schema(description = "the valid to date", example = "2026-01-01T00:00:00Z")
    Instant validUntil;

    protected TrustStatementPartnerLinkV1RequestDto(String subject, Instant validFrom, Instant validUntil) {
