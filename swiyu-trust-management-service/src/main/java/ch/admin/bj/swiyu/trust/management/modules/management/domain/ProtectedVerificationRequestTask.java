...
@Entity
@Getter
@Table(name = "trust_protected_verification_request_task")
@DiscriminatorValue("PROTECTED_VERIFICATION_REQUEST")
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class ProtectedVerificationRequestTask extends TrustTask {
    ...
    public ProtectedVerificationRequestTask(
        ...
        super(
            ...
            dueAt,
            submittedAt,
            TrustTaskType.PROTECTED_VERIFICATION_REQUEST
        );
