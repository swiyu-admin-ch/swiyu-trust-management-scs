...
public final class VerificationQueryV2Details extends TrustStatementDetails {
    ...
    @Valid
    private Map<String, @NotBlank @Size(max = 50) String> purposeName;

    @Valid
    private Map<String, @NotBlank @Size(max = 500) String> purposeDescription;
    ...
    public VerificationQueryV2Details(
        Map<String, @NotBlank @Size(max = 50) String> purposeName,
        Map<String, @NotBlank @Size(max = 500) String> purposeDescription,
