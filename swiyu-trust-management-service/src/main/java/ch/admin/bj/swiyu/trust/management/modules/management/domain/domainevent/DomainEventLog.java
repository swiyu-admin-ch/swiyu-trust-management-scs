...
public class DomainEventLog {
    ...
    public static DomainEventLog createProtectedIssuanceEntryDomainEventLog(
        DomainEventType eventType,
        String triggeredBy,
    ...
    public static DomainEventLog createProtectedIssuanceAuthorizationDomainEventLog(
        DomainEventType eventType,
        String triggeredBy,
