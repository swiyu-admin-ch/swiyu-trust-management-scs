...
describe('TrustOnboardingTaskComponent', () => {
  ...
  it('should show the inCommercialRegister block when partnerType is INDIVIDUAL', () => {
  ...
  it('should NOT show inCommercialRegister block when partnerType is Business', () => {
