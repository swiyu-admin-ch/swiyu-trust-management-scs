...
@RestController
@RequestMapping("/api/v2/trust-statement-partner-links/identity")
public class TrustStatementPartnerLinkIdentityV2Controller {
    ...
    public ResponseEntity<TrustStatementPartnerLinkDto> issueAndPublishIdentityV2Statement(
        @Valid @RequestBody IdentityV2RequestDto request
    ) {
        var statement = this.trustStatementService.issueAndPublishIdentityV2TrustStatement(request);
